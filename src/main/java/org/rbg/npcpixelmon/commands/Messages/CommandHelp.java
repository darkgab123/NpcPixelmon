...
public class CommandHelp {
    ...
    public static boolean helpGeneral(CommandSender s) {
        ...
        s.sendMessage("§f/np criar §e<Nome do NPC> §e[Poke, Upper] §6- Cria um NPC baseado em Citizens, porém configuramente diferente");
    ...
    public static boolean helpCreate(CommandSender s) {
        s.sendMessage("");
        s.sendMessage("§f§cErro: §4/np criar <Nome do NPC> [Poke, Upper]");
        s.sendMessage("");
        return false;
    }
    ...
    public static boolean helpOpen(CommandSender s) {
        s.sendMessage("");
        s.sendMessage("§f§cErro: §4/np abrir [Poke, Upper]");
        s.sendMessage("");
        return false;
    }
